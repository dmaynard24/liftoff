export function extractComponentNames(html) {
    const seen = new Set();
    const components = [];
    ...
    const semanticPattern = /class="[^"]*\b(card|hero|navbar|header|footer|modal|badge|chip|button|btn|tag|avatar|tooltip|sidebar|banner)\b[^"]*"/gi;
